...
{
    public class Api_HANG_SP_TADANController : ApiController
    {
        private HOPLONG_DATABASEEntities db = new HOPLONG_DATABASEEntities();

        // GET: api/Api_HANG_SP_TADAN
        ...
        // DELETE: api/Api_HANG_SP_TADAN/5
        [ResponseType(typeof(DM_HANG_SP))]
