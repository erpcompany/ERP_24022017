...
{
    public class Api_TaikhoanhachtoanTADANController : ApiController
    {
        private HOPLONG_DATABASEEntities db = new HOPLONG_DATABASEEntities();

        // GET: api/Api_TaikhoanhachtoanTADAN
        public List<DM_TAI_KHOAN_HACH_TOAN> GET_DM_TAI_KHOAN_HACH_TOAN()
        {
        ...
        // GET: api/Api_TaikhoanhachtoanTADAN/5
        ...
        // PUT: api/Api_TaikhoanhachtoanTADAN/5
        ...
        // POST: api/Api_TaikhoanhachtoanTADAN
        [ResponseType(typeof(DM_TAI_KHOAN_HACH_TOAN))]
        ...
        // DELETE: api/Api_TaikhoanhachtoanTADAN/5
        [ResponseType(typeof(DM_TAI_KHOAN_HACH_TOAN))]
